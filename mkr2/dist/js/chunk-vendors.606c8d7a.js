"use strict";(self["webpackChunkmkr2"]=self["webpackChunkmkr2"]||[]).push([[998],{223:function(t,e,n){n.d(e,{BH:function(){return v},L:function(){return c},LL:function(){return k},P0:function(){return g},Sg:function(){return b},ZR:function(){return S},aH:function(){return y},eu:function(){return w},hl:function(){return _},m9:function(){return C},vZ:function(){return x}});n(3429),n(560);
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kt{constructor(t,e="asc"){this.field=t,this.dir=e}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function We(t){return new Ae(t,!0)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function Wn(t,e,n){let r;return r=t?n&&(n.merge||n.mergeFields)?t.toFirestore(e,n):t.toFirestore(e):e,r}class Kn extends class{convertValue(t,e="none"){switch(Tt(t)){case 0:return null;case 1:return t.booleanValue;case 2:return bt(t.integerValue||t.doubleValue);case 3:return this.convertTimestamp(t.timestampValue);case 4:return this.convertServerTimestamp(t,e);case 5:return t.stringValue;case 6:return this.convertBytes(_t(t.bytesValue));case 7:return this.convertReference(t.referenceValue);case 8:return this.convertGeoPoint(t.geoPointValue);case 9:return this.convertArray(t.arrayValue,e);case 10:return this.convertObject(t.mapValue,e);default:throw p()}}convertObject(t,e){return this.convertObjectMap(t.fields,e)}convertObjectMap(t,e="none"){const n={};return pt(t,((t,r)=>{n[t]=this.convertValue(r,e)})),n}convertGeoPoint(t){return new dn(bt(t.latitude),bt(t.longitude))}convertArray(t,e){return(t.values||[]).map((t=>this.convertValue(t,e)))}convertServerTimestamp(t,e){switch(e){case"previous":const n=St(t);return null==n?null:this.convertValue(n,e);case"estimate":return this.convertTimestamp(kt(t));default:return null}}convertTimestamp(t){const e=vt(t);return new wt(e.seconds,e.nanos)}convertDocumentKey(t,e){const n=H.fromString(t);m(Je(n));const r=new B(n.get(1),n.get(3)),o=new J(n.popFirst(5));return r.isEqual(e)||f(`Document ${o} contains a document reference within a different database (${r.projectId}/${r.database}) which is not supported. It will be treated as a reference in the current database (${e.projectId}/${e.database}) instead.`),o}}{constructor(t){super(),this.firestore=t}convertBytes(t){return new ln(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new sn(this.firestore,null,e)}}function Yn(t){(function(t){if("L"===t.limitType&&0===t.explicitOrderBy.length)throw new D(C,"limitToLast() queries require specifying at least one orderBy() clause")})((t=X(t,on))._query);const e=Ze(t.firestore),n=new Kn(t.firestore);return Qe(e,t._query).then((e=>{const r=e.map((e=>new Ln(t.firestore,n,e.key,e,t.converter)));return"L"===t._query.limitType&&r.reverse(),new jn(t,r)}))}function Qn(t,e,n,...r){const o=_n((t=X(t,sn)).firestore);let i;return i="string"==typeof(e=(0,s.m9)(e))||e instanceof fn?kn(o,"updateDoc",t._key,e,n,r):Sn(o,"updateDoc",t._key,e),Ye(Ze(t.firestore),[i.toMutation(t._key,be.exists(!0))])}function Xn(t){return Ye(Ze((t=X(t,sn)).firestore),[new Se(t._key,be.none())])}function Zn(t,e){const n=un(t=X(t,an)),r=Wn(t.converter,e),o=wn(_n(t.firestore),"addDoc",n._key,r,null!==n.converter,{});return Ye(Ze(t.firestore),[o.toMutation(n._key,be.exists(!1))]).then((()=>n))}
/**
 * @license
 * Copyright 2022 Google LLC
 *
